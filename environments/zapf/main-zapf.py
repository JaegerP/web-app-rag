...
conn = setup_database(db_name="zapf-resos.sqlite")

def page_header():
    st.write("""
# Mit ZaPF-Beschlüssen chatten

Mit dieser App ist es möglich, Fragen über die Beschlüsse der ZaPF mittels KI beantworten zu lassen.
Dazu liest die App die Resolutionen, Positionspapiere und weiteren Beschlüsse der ZaPF ein und verwendet diese für kontextualisierte Antworten (Retrieval Augmented Generation,RAG).
